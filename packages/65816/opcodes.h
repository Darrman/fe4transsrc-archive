...
"CLD","CLI","CLV","CMP","COP","CPX","CPY","DEC","DEX","DEY","EOR","INC","INX","INY","JML","JMP",
"JSL","JSR","LDA","LDX","LDY","LSR","MVN","MVP","NOP","ORA","PEA","PEI","PER","PHA","PHB","PHD",
...
"TSB","TSC","TSX","TXA","TXS","TXY","TYA","TYX","WAI","WDM","XBA","XCE","BIN","INL","ORG","PAD",
"EQU","DCB","DCW","DCD"};
